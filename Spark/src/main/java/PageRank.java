...
public class PageRank extends Configured implements Tool {
    ...
    public int run(final String[] args) throws Exception {
        ...
        ArrayList<Long> old_top = new ArrayList<>(10);
        int res = 0;
        for (int i = 0; i < 10; ++i) {
    ...
    static public void main(final String[] args) throws Exception {
        ...
        String timeConsumedMillis = String.valueOf((finish - start)/(1000000*1000*60.0));
    ...
    public static class PageRankJob2Reducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(final Text key, final Iterable<Text> values, final Context context)
            ...
            new_rank = alpha * new_rank + (1 - alpha) * (1000. / 4847571.); //or 572418
