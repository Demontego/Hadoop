...
public class RobotsFilterTest {
    ...
    public void testSimpleCase() {
        Robots_txt filter = new Robots_txt("Disallow: /users");
    ...
    public void testEmptyCase()  {
        Robots_txt filter = new Robots_txt();
    ...
    public void testRuleEscaping()   {
        ...
        Robots_txt filter = new Robots_txt("Disallow: *.php$");
    ...
    public void testAllCases()  {
        ...
        Robots_txt filter = new Robots_txt(rules);
    ...
    @Test
    public void testURLLib() throws MalformedURLException {
